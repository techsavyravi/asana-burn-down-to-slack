...
send2SlackCustomURL("Stats for yesterday (" + yesterday.strftime("%d-%m-%Y") + "). Let's get crunching.", sendString, "https://hooks.sla ck.com/services/TPMAJ1G13/B01HYE4E3KR/DJauxGYrzH292mlgtpRiBkIA")
# print(sendString)